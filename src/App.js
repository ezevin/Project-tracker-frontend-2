...
class App extends Component {
  ...
  componentDidMount(){
    ...
    // fetch(`http://localhost:3000/api/v1/projects/${this.state.pID}`)
    // .then(res => res.json())
    ...
    // fetch('http://localhost:3000/api/v1/user_materials')
    // .then(res => res.json())
  ...
  deleteProject = (dproject) => {
    ...
    fetch(`http://localhost:3000/api/v1/projects/${deleted.id}`, {
      method:"delete"
    })
  ...
  deleteMaterial = (dmaterial) => {
    ...
    fetch(`http://localhost:3000/api/v1/materials/${deleted.id}`, {
      method:"delete"
    })
